...
# UPLOAD FILE (define this BEFORE using it)
...
if uploaded_file:
    ...
    if st.button("Run Processing"):
        ...
        # MODEL NUMBER
        model_map = {"-5": "05", "-10": "10", "-18": "18", "-21": "21",
                    "-33": "33", "-35": "35", "-41": "41",
        ...
        # SIZE
        size_map = {"0.5 x": "05", "0.7 x": "75", "1 x": "01", "1.5 x": "15",
        ...
        # BODY MATERIAL
        body_mat_map = {"WCC": "A", "LCC": "B", "A105": "C", "LF2": "D",
        ...
        # ACTUATOR
        act_model_map = {"Top Mounted Handwheel": "20", "87": "87", "88": "88",
                        "51": "51", "52": "52", "53": "53",
                        "37": "37", "38": "38",
        ...
        # PIN CODE
        pin_columns = ["Model Number-Code", "In x Body x Out Size-Code", "Rating Class-Code",
        ...
        # PIN DESCRIPTION
        desc_columns = ["Model Number", "In x Body x Out Size", "Rating Class",
        ...
        df["PIN-Code description"] = (
            df[available_desc_cols].fillna("").astype(str).agg(", ".join, axis=1)
            if available_desc_cols else ""
        )
